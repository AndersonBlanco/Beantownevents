...
export default function Page(){ 
    ...
    const [content, setContent] = useState(null); //Anderson | used as a variable that re-renders and updates the DOM (what stae variables do) to display the new state (ie the new content)
      ...
      <div className="timeline">                          {/* Got this information from w3 schools. It is making it so the boxes are stationed on either side of the line */}
        <div className="container left"> {/* positions items left on the timeline, controlled through css though */}
          <div className="content">{/* wraps each event's actual content boc */}
            <h2>
              <a  onClick = {() => setContent(GroupProject4)}>September 14th, 1716</a>
            </h2>
        ...
        <div className="container right"> {/* positions items right on the timeline, controlled through css though */}
          <div className="content"> {/* wraps each event's actual content boc */}
            <h2>
              <a  onClick = {() => setContent(GroupProject3)}>December 16th, 1773</a>
            </h2>
          ...
          <div className="container left"> {/* positions items left on the timeline, controlled through css though */}
            <div className="content"> {/* wraps each event's actual content boc */}
              <h2>
                <a onClick = {() => setContent(GroupProject2)}>April 18th, 1775</a>
              </h2>
        ...
        <div className="container right"> {/* positions items right on the timeline, controlled through css though */}
          <div className="content"> {/* wraps each event's actual content boc */}
            <h2>
              <a onClick = {() => setContent(GroupProject5)}>April 19th, 1775</a>
            </h2>
       ...
       <div className="celeb_container">
        {
         ...
         <nav className="nav">
                <ul>
                <li><a onClick = {() => setContent(null)}>Homepage</a></li>
