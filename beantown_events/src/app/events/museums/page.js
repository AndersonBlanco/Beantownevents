...
export default function Page(){
    ...
    <div className="slideshow-container-museums">
        ...
        <div className="mySlides-museums fade-museums">
            ...
            <Link className="link" href="/credits"><Image className = "img-musmeum-slideshow"  src={BostonCommon} alt="A dusktime painting of the Boston Common
        ...
        <div className="mySlides-museums fade-museums">
            <div className="numbertext-museums">2 / 3</div>
             <Link className="link" href="/credits"><Image className = "img-musmeum-slideshow"  src={eljaleo}
        ...
        <div className="mySlides-museums fade-museums">
            ...
            <Link className="link" href="/credits"><Image className = "img-musmeum-slideshow" src={train} alt="A train entering the station at Saint-Lazare"/></Link>
